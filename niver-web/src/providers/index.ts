...
export const BaseApi = axios.create({ baseURL: 'https://niverdequem.tk:8090' });
export const PersonApi = axios.create({ baseURL: 'https://niverdequem.tk:8090/person/api' });
export const GroupApi = axios.create({ baseURL: 'https://niverdequem.tk:8090/group/api' });
export const MemberApi = axios.create({ baseURL: 'https://niverdequem.tk:8090/member/api' });
export const CalendarApi = axios.create({ baseURL: 'https://niverdequem.tk:8090/calendar/api' });
export const InviteApi = axios.create({ baseURL: 'https://niverdequem.tk:8090/invite/api' });
